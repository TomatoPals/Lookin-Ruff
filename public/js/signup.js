$(document).ready(() => {
  ...
  const dogTemperament = $("#dogTemperament-input");
  ...
  signUpForm.on("submit", event => {
    ...
    const userData = {
      ...
      dogTempermentId: dogTemperament.val().trim(),
      dogBreedId: dogType.val().trim()
    };
  ...
  function signUpUser(
    ...
    $.post("/api/signup", {
      ...
      dogName: dogName,
      dogNote: dogNote,
      dogTempermentId: dogTempermentId,
